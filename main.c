#pragma config(Motor,  port4,           elevatorLeft,  tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port5,           elevatorLeftB, tmotorServoContinuousRotation, openLoop, reversed)
...
#pragma config(Motor,  port8,           elevatorRightB, tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port9,           elevatorRight, tmotorServoContinuousRotation, openLoop, reversed)
